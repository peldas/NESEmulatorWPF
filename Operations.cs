...
namespace NESEmulatorWPF
{
    internal class Operations
    {
        ...
        {
            Accumulator, // arg1 is A
            Immediate, // arg1 is constant
            ZeroPage, // arg1 is 8-bit address (in zero-page)
            ZeroPageX, // arg1 is 8-bit address (in zero-page, add X to address)
            ZeroPageY, // arg1 is 8-bit address (in zero-page, add Y to address)
            Relative, // arg1 is 8-bit relative offset
            Absolute, // arg1 and arg 2 are a 16-bit address
            AbsoluteX, // arg1 and arg 2 are a 16-bit address (add X to address)
            AbsoluteY, // arg1 and arg 2 are a 16-bit address (add Y to address)
            Indirect, // arg1 and arg2 are a 16-bit address
            IndirectX, // arg1 and arg2 are 16-bit address (in zero-page, add X to address)
            IndirectY, // arg1 and arg2 are 16-bit address (in zero-page, add Y to address)
            Implied // obvious from function name
        }
        ...
        private static readonly Dictionary<int, Tuple<Instruction, AddressingMode>> mapping = new Dictionary<int, Tuple<Instruction, AddressingMode>>
        {
            ...
            { 0x69, new Tuple<Instruction, AddressingMode>(Instruction.ADC, AddressingMode.IndirectX) },
